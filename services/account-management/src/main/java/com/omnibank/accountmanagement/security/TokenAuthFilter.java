 ...
 * - property: account-management.security.adminBearerToken
...
public class TokenAuthFilter extends OncePerRequestFilter {
  ...
  public TokenAuthFilter(
      @Value("${account-management.security.adminBearerToken:${ADMIN_BEARER_TOKEN:admin-token-dev}}") String expected) {
