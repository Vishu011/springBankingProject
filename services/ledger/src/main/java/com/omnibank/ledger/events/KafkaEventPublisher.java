...
/**
 * Kafka-based event publisher for ledger-service.
 * Enabled when ledger.eventPublisher=kafka (default is logging).
 */
@ConditionalOnProperty(prefix = "ledger", name = "eventPublisher", havingValue = "kafka")
@Component
