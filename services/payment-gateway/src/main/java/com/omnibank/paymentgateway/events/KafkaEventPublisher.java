...
/**
 * Kafka-based event publisher for payment-gateway.
 * Enabled when paymentGateway.eventPublisher=kafka.
 */
@ConditionalOnProperty(prefix = "payment-gateway", name = "eventPublisher", havingValue = "kafka")
@Component
